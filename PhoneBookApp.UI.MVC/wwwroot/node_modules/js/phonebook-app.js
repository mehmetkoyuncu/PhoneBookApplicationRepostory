...
function AddPerson() {
    ...
    $.ajax({
        type: "POST",
        url: "https://localhost:44347/person/addperson",
        datatype: "json",
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "https://localhost:44347/person/removeperson",
                    datatype: "json",
                    contentType: "application/json; charset=utf-8",
...
function GetPerson() {
    $.ajax({
        type: "GET",
        url: "https://localhost:44347/person/GetAllPerson",
        datatype: "json",
        contentType: "application/json; charset=utf-8",
        success: function (data) {
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "https://localhost:44347/contact/RemoveContact",
                    datatype: "json",
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify({ "Id": Id }),
                    success: function (data) {
...
function ViewContact(id) {
    ...
    $.ajax({
        type: "POST",
        url: "https://localhost:44347/contact/GetContactForUser",
        datatype: "json",
        contentType: "application/json; charset=utf-8",
...
function AddContact() {
    ...
    var Address = $("#selectboxLocationaddContact").val();
    var UserId = document.getElementById("personIdHide").innerHTML;
    debugger;
    $.ajax({
        type: "POST",
        url: "https://localhost:44347/contact/addcontact",
        datatype: "json",
        contentType: "application/json; charset=utf-8",
...
function AddReport() {
    var locationName = $("#selectboxLocationaddContact").val();
    $.ajax({
        type: "POST",
        url: "https://localhost:44333/LocationReport/DemandLocationReport",
        datatype: "json",
        contentType: "application/json; charset=utf-8",
        data: JSON.stringify({ 'Location': locationName }),
        success: function (data) {
            debugger;
            a = data.recordUsersCount;
            b = data.recordNumberCount;
            c = data.location;
            debugger;
...
function GetReports() {
    $.ajax({
        type: "GET",
        url: "https://localhost:44333/locationReport/GetAll",
        datatype: "json",
        contentType: "application/json; charset=utf-8",
        success: function (data) {
            $("#tableReport").DataTable({
                ...
                data: data,
                "columns": [
                    { data: "creaatedTime", "autoWidth": true },
                    ...
                    {
                        "render": function (data, type, row) {
                            return "<a  class='btn btn-danger text-light' onclick=DeleteReport('" + row.id + "')><i class=\"fas fa-trash-alt mr-1\"></i>Sil</a>";
                        }
                    }
                ]
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "https://localhost:44333/LocationReport/RemoveReport",
                    datatype: "json",
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify({ "Id": id }),
                    success: function (data) {
